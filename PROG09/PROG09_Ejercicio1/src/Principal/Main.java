...
Como ya sabes, para poder realizar estas tareas es necesarios que nuestros objetos que representan cuentas bancarias sean serializables. 
Habrá que realizar las convenientes modificaciones a la clase CuentaBancaria.

Ejercicio 2

Añade una nueva opción al menú de la aplicación denominado "Listado clientes" de modo que al seleccionarla, 
se genere un fichero de texto denominado ListadoClientesCCC.txt que contenga una línea de texto por cada cuenta bancaria almacenada, donde se visualice nombre del propietario y CCC por cada una de ellas.
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        JOptionPane.showInputDialog("Patatin");
        do {
            ...
            switch (menu) {
                ...
                case (6):
                    ...
                    break;
                case (7):
                    IBAN = JOptionPane.showInputDialog("Introduce el IBAN de la cuenta que desea eliminar:");
                    if (banco.eliminarCuenta(IBAN) == true) {
